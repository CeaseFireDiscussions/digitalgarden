---
{"dg-publish":true,"permalink":"/yada-yada-pauses/58-heb-12-yada-yada/","tags":["#TheScrolls","#YadaYadaPauses","#unrighteous","#Righteous"]}
---
...
###### v1 
Therefore let's also, seeing we are surrounded by so great a cloud of witnesses, lay aside every weight and the sin which so easily entangles us, and [^18]let's run with perseverance the race that is set before us, 
...
###### v9 
Furthermore, we had the fathers of our flesh to chasten us, and we paid them respect. Shall we not much rather be in [^10]subjection to the Father of spirits, and live? 
...
- [^3]Follow after peace 
	...
	- and the sanctification <mark style="background: #CD04BBA6;">//set apartness=Holy//</mark>
		- [^4]without which <mark style="background: #4DA6EDA6;">no man</mark> will see the Lord, 
- looking carefully 
