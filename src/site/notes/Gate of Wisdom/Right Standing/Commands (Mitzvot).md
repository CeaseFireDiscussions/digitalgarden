...
- **Blessing**: General blessings (Deuteronomy 28:1-14).
- **Penalty or Consequence**: General curses (Deuteronomy 28:15-68).
- **Offering or Ransom?**: "Shall not" if unintentional, [[Gate of Wisdom/Offering/Sin Offering\|Sin Offering]]. 
- **Note:** Could these fall into the deliberately not doing category of [[Zunpublished/Guilt Offering\|Guilt Offering]] if they are against another person and restitution can be made?
...
- **Note:** Seems pretty difficult to plant something and not know it. If intentional, none specified.
